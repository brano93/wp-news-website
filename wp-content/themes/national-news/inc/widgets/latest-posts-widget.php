<?php
if ( ! class_exists( 'National_News_Latest_Posts_Widget' ) ) {
	/**
	 * Adds National News Latest Posts Widget.
	 */
	class National_News_Latest_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$latest_posts_widget = array(
				...
				'description' => __( 'Retrive Latest Posts Widgets', 'national-news' ),
			);
			parent::__construct(
				'national_news_latest_posts_widget',
				__( 'Adore Widget: Latest Posts Widget', 'national-news' ),
				$latest_posts_widget
			);
		}
